...
export async function GET(request: NextRequest) {
  console.log('Google Calendar Composio callback received');
  ...
  try {
    ...
    return NextResponse.redirect('/dashboard/integrations?success=true&source=composio_calendar_callback');
  } catch (error) {
    console.error('Error handling Google Calendar Composio callback:', error);
