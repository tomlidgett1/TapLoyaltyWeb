...
export async function GET(request: NextRequest) {
  console.log('Testing Microsoft Outlook Composio integration');
  
  try {
    // Extract parameters
    const { searchParams } = new URL(request.url);
    const merchantId = searchParams.get('merchantId');
    const customIntegrationId = searchParams.get('integrationId') || '2f4a80d5-2396-49b2-a7f7-05025622bcaa';
    ...
    console.error('Error in Microsoft Outlook integration:', error);
