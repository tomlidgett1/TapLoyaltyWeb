            ...
            >
              ...
              <div className="w-full space-y-3">
                ...
                <motion.button
                  ...
                  className="w-full h-[54px] bg-white text-black text-[15px] font-semibold rounded-2xl transition-all duration-200 hover:bg-white/90 active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-70 relative overflow-hidden"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <motion.button
                  ...
                  className="w-full h-[54px] bg-white/[0.08] text-white text-[15px] font-medium rounded-2xl transition-all duration-200 hover:bg-white/[0.12] border border-white/[0.08]"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <motion.p 
                  className="text-[11px] text-white/20 text-center pt-2"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
