          ...
          {currentStep === 5 && (
            <div className="px-6 pt-2 pb-4 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-sm">Reward Details</Label>
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      className="h-8 gap-1 text-blue-600 hover:text-blue-700 hover:bg-blue-50"
                    ...
                    {formData.conditions.newCustomer ? (
                      ...
                      <div className="space-y-4">
                        ...
                        {!formData.conditions.useTransactionRequirements && 
                         ...
                         !formData.conditions.useTimeRequirements && 
                         formData.rewardVisibility === 'new' && (
                          <p className="text-sm text-gray-500 italic">Only new customer requirement applied. This reward is available to new customers only.</p>
                        )}
                      </div>
                    )}
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-sm">Limitations</Label>
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      className="h-8 gap-1 text-blue-600 hover:text-blue-700 hover:bg-blue-50"
