...
export function IntroductoryRewardSheet({ open, onOpenChange }: IntroductoryRewardSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-md md:max-w-xl lg:max-w-2xl p-0 overflow-hidden flex flex-col">
          ...
          <SheetHeader className="mb-2">
            <SheetTitle className="text-xl">
              <span className="flex items-center gap-2">
                ...
                <span>
                  <span className="text-[#007AFF]">Introductory</span>
                  <span> Reward</span>
                </span>
              </span>
            </SheetTitle>
